     ...
     stages {
         ...
         stage('unit testing') {
             steps{
                ...
                xcodebuild  -scheme SearchBarInTable  -destination 'platform=iOS Simulator,OS=13.1,name=iPhone 11 Pro Max' test > /Users/jenkins/Desktop/iOS-Project/ut_results.txt
